  ...
  (_props, ref) => {
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        toast.success("Thank you! Your request was submitted succcessfully.", {
          id: "contact-success",
        });
        setValues(initialValues);
      } catch (err) {
        let message = "An error occurred with form submission.";
        if (err instanceof Error) {
          message = err.message;
        }
        toast.error(message, { id: "contact-error" });
      } finally {
        setSubmitting(false);
      }
    };
    ...
    return (
      <section
        id="contact"
        ref={ref}
        className="scroll-mt-20 py-16 px-4 bg-[#EAF8FB] text-center"
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-[#0C2D48]">
            Let&apos;s Connect
          </h2>
          <p className="text-[#334E68] mb-6">
            Ready to launch your site or idea? Reach out and let&apos;s talk.
          </p>
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-xl p-8">
              <form
                ...
                method="POST"
                noValidate
                className="p-6 border-[#53cdd5] border-2 rounded-lg space-y-6 shadow-lg"
              >
                <div>
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto px-6 py-3 bg-[#FF5722] text-white rounded hover:bg-[#e64a19]"
                >
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 md:text-center">
              ...
              <div className="space-y-4 text-gray-700 font-sans">
                ...
                <p className="flex items-center gap-3 py-2 border-b last:border-b-0 border-gray-200">
                  ...
                  <a
                    href="https://www.tinysitelab.com"
                    className="hover:underline text-[#0C2D48] hover:text-[#FF5722] transition-colors"
                  >
                    tinysite.lab.com
                  </a>
          ...
          <p className="mt-8 text-sm italic text-gray-600 text-center max-w-xl mx-auto">
            <span
              role="img"
              aria-label="beaker"
              className="text-lg align-middle mr-2"
            >
              🔬
            </span>
            Tiny Site Lab&apos;s science vibe is inspired by my science
            beginnings — because every great website starts with a little
            experiment!
          </p>
        </div>
      </section>
